          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 text-center">
                 ...
                 <Link 
                   href={`/dashboard/messages?title=${encodeURIComponent('Question about ' + listing.title)}`}
                   className="w-full py-3 bg-blue-600 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2 mb-3 shadow-lg shadow-blue-500/20 hover:scale-[1.02] active:scale-95"
                 >
